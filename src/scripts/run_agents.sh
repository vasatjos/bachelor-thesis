...
./run_thesis.sh monte_carlo mc1 $MC_BASE  --epsilon 0.05 --gamma 0.99 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh monte_carlo mc2 $MC_BASE  --epsilon 0.1 --gamma 0.99 --every_visit --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh monte_carlo mc3 $MC_BASE  --epsilon 0.1 --gamma 0.99 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh monte_carlo mc4 $MC_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.01 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh monte_carlo mc5 $MC_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.05 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh monte_carlo mc6 $MC_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.1 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh monte_carlo mc7 $MC_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.1 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials --self_play --self_play_update_freq 10000 
...
./run_thesis.sh q_learning ql1 $QL_BASE  --epsilon 0.05 --gamma 0.99 --alpha 0.1 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh q_learning ql2 $QL_BASE  --epsilon 0.1 --gamma 0.99 --alpha 0.1 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh q_learning ql3 $QL_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.01 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh q_learning ql4 $QL_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.05 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh q_learning ql5 $QL_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.1 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
./run_thesis.sh q_learning ql6 $QL_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.1 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials --self_play --self_play_update_freq 10000 
./run_thesis.sh q_learning ql8 $QL_BASE  --epsilon 0.5 --epsilon_decay 0.99999 --min_epsilon 0.001 --gamma 0.99 --alpha 0.2 --hand_state_option count_truncated --truncated_hand_size 4 --played_subset specials 
